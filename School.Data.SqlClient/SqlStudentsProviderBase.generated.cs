/*
	...
	Important: Do not modify this file. Edit the file SqlStudentsProvider.cs instead.
*/
...
namespace School.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlStudentsProviderBase : StudentsProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlStudentsProviderBase"/> instance.
		/// </summary>
		public SqlStudentsProviderBase()
		{
		}
	...
	public SqlStudentsProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Students> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Students_Get_List", _useStoredProcedure);
